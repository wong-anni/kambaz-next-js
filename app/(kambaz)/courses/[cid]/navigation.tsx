  ...
  return ( 
    <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0"> 
      ...
      <Link href={`/courses/${cid}/modules`} id="wd-course-modules-link"
        className={`list-group-item border-0 
            ${pathname.includes("modules") ? "active": "text-danger"}`}>Modules</Link>
      ...
      <Link href={`/courses/${cid}/assignments`} id="wd-course-assignments-link"
        className={`list-group-item border-0 
            ${pathname.includes("assignments") ? "active": "text-danger"}`}>Assignments</Link> 
      <Link href={`/courses/${cid}/quizzes`} id="wd-course-quizzes-link"
        className={`list-group-item border-0 
            ${pathname.includes("quizzes") ? "active": "text-danger"}`}>Quizzes</Link> 
      <Link href={`/courses/${cid}/projects`} id="wd-course-projects-link"
        className={`list-group-item border-0 
            ${pathname.includes("projects") ? "active": "text-danger"}`}>Projects</Link>
      <Link href={`/courses/${cid}/exams`} id="wd-course-exams-link"
        className={`list-group-item border-0 
            ${pathname.includes("exams") ? "active": "text-danger"}`}>Exams</Link>
